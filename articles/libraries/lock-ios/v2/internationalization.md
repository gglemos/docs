...
By default **Lock v2 for iOS** displays all text in English. If you wish to display text in another language or you wish to alter the text values for your application, you may provide alternative `Lock.strings` file and define values to be used for the various text items that Lock will display.
